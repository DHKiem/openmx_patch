...
/* D.H. Kiem : Zeeman term in Global magnetic field for NC system. STARTLINE */

  input_logical("scf.NC.Global.Zeeman",&Global_Zeeman_NC_switch,0);

  if (SpinP_switch!=3 && Global_Zeeman_NC_switch==1){
    if (myid==Host_ID){
      printf("The Zeeman term is not supported for a collinear DFT calculation.\n");
      printf("Check your input file.\n\n");
    }
  ...
  if (Global_Zeeman_NC_switch==1 && Hub_U_occupation!=2){
    if (myid==Host_ID){
      printf("The Zeeman term for spin is supported in case of scf.Hubbard.Occupation=dual.\n");
      printf("Check your input file.\n\n");
    }
  ...
  if (1<=Constraint_NCS_switch && Global_Zeeman_NC_switch==1){
    if (myid==Host_ID){
      printf("For spin magnetic moment, the constraint scheme and the Zeeman term\n");
      printf("are mutually exclusive.  Check your input file.\n\n");
    }
  ...
  if (Zeeman_NCS_switch==1 && Global_Zeeman_NC_switch==1){
    if (myid==Host_ID){
      printf("The global Zeeman term and constraint type Zeeman term\n");
      printf("are mutually exclusive.  Check your input file.\n\n");
    }
    MPI_Finalize();
    exit(0);
  ...
  if (Zeeman_NCO_switch==1 && Global_Zeeman_NC_switch==1){
    if (myid==Host_ID){
      printf("The global Zeeman term and constraint type Zeeman term\n");
      printf("are mutually exclusive.  Check your input file.\n\n");
    }
  ...
  input_double("scf.NC.Global.Mag.Field",&Global_Mag_Field,(double)0.0);
  ...
  ***************************************/
  ...
  Global_Mag_Field = Global_Mag_Field/(2.35051742*100000.0);
  
  input_double("scf.NC.Global.Mag.Field.theta",&Global_Mag_Field_theta,(double)0.0);
  input_double("scf.NC.Global.Mag.Field.phi",&Global_Mag_Field_phi,(double)0.0);

  Global_Mag_Field_theta = Global_Mag_Field_theta *PI/180.0;
  Global_Mag_Field_phi   = Global_Mag_Field_phi   *PI/180.0;
